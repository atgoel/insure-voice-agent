...
- Existing implementation: `functions/rank_products/main.py` — base scoring implemented. Input validation and audit trail are missing.
- Tests: `tests/test_rank_products.py` using pytest.
- The Root Agent (not this function) generates the TTS-ready explanation text from the top-3 output.
